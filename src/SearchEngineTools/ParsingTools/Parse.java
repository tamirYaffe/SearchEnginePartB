...
//private static CountryService countryService = CountryService.getInstance();
    ...
    public List<ATerm> parseQuery(List<String> queryLines, boolean spellCheck, int maxSynonyms){
        ...
        Map<String, ATerm> occurrencesAndPositionsOfTerms = new HashMap<>();
        //get all terms in document and their occurrences
        addAllTermsToOccurrancesOfTerms(occurrencesAndPositionsOfTerms,queryTokenList);
        List<Token> wordsToAdd = queryTokenList.getRelatedWords();
        for (Token token:wordsToAdd) {
