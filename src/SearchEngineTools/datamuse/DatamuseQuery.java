...
package SearchEngineTools.datamuse;
...
public class DatamuseQuery {
    ...
    private String synonymsMaxResults(String word, int maxResults) {
        String s = word.replaceAll(" ", "+");
        return getJSON("http://api.datamuse.com/words?rel_syn="+s+"&max="+maxResults);
    }
     ...
     */
    public String spelledSimilar(String word) {
        String s = word.replaceAll(" ", "+");
        return getJSON("http://api.datamuse.com/words?sp=" + s);
    }


    private String spelledSimilarMaxResults(String word, int maxResults) {
        String s = word.replaceAll(" ", "+");
